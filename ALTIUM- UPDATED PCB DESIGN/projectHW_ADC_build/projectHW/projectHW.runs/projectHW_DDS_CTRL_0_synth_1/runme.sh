...
HD_PWD='C:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/projectHW/projectHW.runs/projectHW_DDS_CTRL_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log projectHW_DDS_CTRL_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source projectHW_DDS_CTRL_0.tcl
