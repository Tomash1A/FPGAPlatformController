...
HD_PWD='C:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/adc/adc.runs/projectHW_FPGA_CLK_BUF_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log projectHW_FPGA_CLK_BUF_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source projectHW_FPGA_CLK_BUF_0.tcl
