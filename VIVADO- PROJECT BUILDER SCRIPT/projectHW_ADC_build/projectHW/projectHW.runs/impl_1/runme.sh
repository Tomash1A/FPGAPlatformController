...
HD_PWD='C:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/projectHW/projectHW.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log projectHW_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source projectHW_wrapper.tcl -notrace
