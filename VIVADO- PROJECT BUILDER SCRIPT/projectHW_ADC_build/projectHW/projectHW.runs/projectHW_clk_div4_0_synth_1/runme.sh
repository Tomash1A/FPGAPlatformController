...
HD_PWD='C:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/projectHW/projectHW.runs/projectHW_clk_div4_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log projectHW_clk_div4_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source projectHW_clk_div4_0.tcl
