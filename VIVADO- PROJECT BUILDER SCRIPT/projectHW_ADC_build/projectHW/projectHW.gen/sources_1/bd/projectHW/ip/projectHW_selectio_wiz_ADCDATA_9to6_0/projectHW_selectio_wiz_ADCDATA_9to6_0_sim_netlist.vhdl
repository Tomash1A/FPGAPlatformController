...
--               c:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/projectHW/projectHW.gen/sources_1/bd/projectHW/ip/projectHW_selectio_wiz_ADCDATA_9to6_0/projectHW_selectio_wiz_ADCDATA_9to6_0_sim_netlist.vhdl
-- Design      : projectHW_selectio_wiz_ADCDATA_9to6_0
...
entity projectHW_selectio_wiz_ADCDATA_9to6_0_selectio_wiz is
  port (
  ...
  attribute DEV_W of projectHW_selectio_wiz_ADCDATA_9to6_0_selectio_wiz : entity is 12;
  attribute SYS_W : integer;
  attribute SYS_W of projectHW_selectio_wiz_ADCDATA_9to6_0_selectio_wiz : entity is 6;
end projectHW_selectio_wiz_ADCDATA_9to6_0_selectio_wiz;

architecture STRUCTURE of projectHW_selectio_wiz_ADCDATA_9to6_0_selectio_wiz is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity projectHW_selectio_wiz_ADCDATA_9to6_0 is
  port (
    data_in_from_pins_p : in STD_LOGIC_VECTOR ( 5 downto 0 );
    data_in_from_pins_n : in STD_LOGIC_VECTOR ( 5 downto 0 );
    data_in_to_device : out STD_LOGIC_VECTOR ( 11 downto 0 );
  ...
  attribute NotValidForBitStream of projectHW_selectio_wiz_ADCDATA_9to6_0 : entity is true;
  attribute DEV_W : integer;
  attribute DEV_W of projectHW_selectio_wiz_ADCDATA_9to6_0 : entity is 12;
  attribute SYS_W : integer;
  attribute SYS_W of projectHW_selectio_wiz_ADCDATA_9to6_0 : entity is 6;
end projectHW_selectio_wiz_ADCDATA_9to6_0;

architecture STRUCTURE of projectHW_selectio_wiz_ADCDATA_9to6_0 is
  attribute DEV_W of inst : label is 12;
  attribute SYS_W of inst : label is 6;
begin
inst: entity work.projectHW_selectio_wiz_ADCDATA_9to6_0_selectio_wiz
     port map (
      clk_in => clk_in,
