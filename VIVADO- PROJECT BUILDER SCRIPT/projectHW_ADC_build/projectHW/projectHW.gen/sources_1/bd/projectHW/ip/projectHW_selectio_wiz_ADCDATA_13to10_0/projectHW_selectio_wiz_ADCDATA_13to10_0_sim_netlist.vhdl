...
--               c:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/projectHW/projectHW.gen/sources_1/bd/projectHW/ip/projectHW_selectio_wiz_ADCDATA_13to10_0/projectHW_selectio_wiz_ADCDATA_13to10_0_sim_netlist.vhdl
...
entity projectHW_selectio_wiz_ADCDATA_13to10_0_selectio_wiz is
  port (
  ...
  attribute DEV_W of projectHW_selectio_wiz_ADCDATA_13to10_0_selectio_wiz : entity is 8;
  attribute SYS_W : integer;
  attribute SYS_W of projectHW_selectio_wiz_ADCDATA_13to10_0_selectio_wiz : entity is 4;
end projectHW_selectio_wiz_ADCDATA_13to10_0_selectio_wiz;

architecture STRUCTURE of projectHW_selectio_wiz_ADCDATA_13to10_0_selectio_wiz is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity projectHW_selectio_wiz_ADCDATA_13to10_0 is
  port (
    data_in_from_pins_p : in STD_LOGIC_VECTOR ( 3 downto 0 );
    data_in_from_pins_n : in STD_LOGIC_VECTOR ( 3 downto 0 );
    data_in_to_device : out STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute NotValidForBitStream of projectHW_selectio_wiz_ADCDATA_13to10_0 : entity is true;
  attribute DEV_W : integer;
  attribute DEV_W of projectHW_selectio_wiz_ADCDATA_13to10_0 : entity is 8;
  attribute SYS_W : integer;
  attribute SYS_W of projectHW_selectio_wiz_ADCDATA_13to10_0 : entity is 4;
end projectHW_selectio_wiz_ADCDATA_13to10_0;

architecture STRUCTURE of projectHW_selectio_wiz_ADCDATA_13to10_0 is
  attribute DEV_W of inst : label is 8;
  attribute SYS_W of inst : label is 4;
begin
inst: entity work.projectHW_selectio_wiz_ADCDATA_13to10_0_selectio_wiz
     port map (
      clk_in => clk_in,
