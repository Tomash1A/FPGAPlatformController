# build.tcl — creates the projectHW ADC variant for Avnet MicroZed 7020
# Usage: vivado -mode batch -source build.tcl -tclargs <path_to_projectHW_ADC_build>
...
set hdl_files [list \
    ...
    [file normalize "$origin_dir/src/adc_capture.v"] \
]
...
# Block design
# ---------------------------------------------------------------------------
source [file normalize "$origin_dir/projectHW_wADC.tcl"]
