...
HD_PWD='C:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/adc/adc.runs/projectHW_dds_compiler_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log projectHW_dds_compiler_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source projectHW_dds_compiler_0_1.tcl
