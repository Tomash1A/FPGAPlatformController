...
-- Date        : Mon Jun 29 12:03:16 2026
-- Host        : CS-RO-PC29 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/shtomer/WIS_work/WIP/build_Test/projectHW_ADC_build/adc/adc.gen/sources_1/bd/projectHW/ip/projectHW_DAC1_BUF_OUT_0/projectHW_DAC1_BUF_OUT_0_sim_netlist.vhdl
...
entity projectHW_DAC1_BUF_OUT_0_selectio_wiz is
  port (
  ...
  attribute DEV_W of projectHW_DAC1_BUF_OUT_0_selectio_wiz : entity is 32;
  attribute SYS_W : integer;
  attribute SYS_W of projectHW_DAC1_BUF_OUT_0_selectio_wiz : entity is 16;
end projectHW_DAC1_BUF_OUT_0_selectio_wiz;

architecture STRUCTURE of projectHW_DAC1_BUF_OUT_0_selectio_wiz is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity projectHW_DAC1_BUF_OUT_0 is
  port (
    data_out_from_device : in STD_LOGIC_VECTOR ( 31 downto 0 );
    data_out_to_pins_p : out STD_LOGIC_VECTOR ( 15 downto 0 );
    data_out_to_pins_n : out STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute NotValidForBitStream of projectHW_DAC1_BUF_OUT_0 : entity is true;
  attribute DEV_W : integer;
  attribute DEV_W of projectHW_DAC1_BUF_OUT_0 : entity is 32;
  attribute SYS_W : integer;
  attribute SYS_W of projectHW_DAC1_BUF_OUT_0 : entity is 16;
end projectHW_DAC1_BUF_OUT_0;

architecture STRUCTURE of projectHW_DAC1_BUF_OUT_0 is
  attribute DEV_W of inst : label is 32;
  attribute SYS_W of inst : label is 16;
begin
inst: entity work.projectHW_DAC1_BUF_OUT_0_selectio_wiz
     port map (
      clk_in => clk_in,
      clk_reset => clk_reset,
