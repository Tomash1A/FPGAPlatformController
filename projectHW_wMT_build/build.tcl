# build.tcl — creates the projectHW Vivado project for Avnet MicroZed 7020
# Usage: vivado -mode batch -source build.tcl -tclargs <path_to_projectHW_wMT_build>
...
set project_name projectHW_wMT
...
# ---------------------------------------------------------------------------
# Create project  (lives in <build_folder>/projectHW_wMT/)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Block design  (sources from projectHW_wMT.tcl)
# ---------------------------------------------------------------------------
source [file normalize "$origin_dir/projectHW_wMT.tcl"]
