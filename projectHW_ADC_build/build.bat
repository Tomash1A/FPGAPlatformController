@echo off
REM -----------------------------------------------------------------------
REM  build.bat  —  Creates the projectHW ADC variant Vivado project
REM  Requirements: Vivado 2021.1 must be on the system PATH.
REM                Run from the Vivado 2021.1 command prompt, or add
REM                C:\Xilinx\Vivado\2021.1\bin to your system PATH first.
REM -----------------------------------------------------------------------
...
echo Building projectHW ADC variant ...
